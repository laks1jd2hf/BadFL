...
class MnistHelper(Helper):

    def create_model(self):
        local_model = None
        target_model = None

        local_model = MnistNet(name='Local', created_time=self.params['current_time'])
        target_model = MnistNet(name='Target', created_time=self.params['current_time'])
